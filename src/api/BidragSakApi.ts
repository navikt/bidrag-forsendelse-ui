...
export class HttpClient<SecurityDataType = unknown> {
    ...
    constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
        this.instance = axios.create({
            ...axiosConfig,
            baseURL: axiosConfig.baseURL || "https://bidrag-sak-feature.dev.intern.nav.no",
        });
        this.secure = secure;
        this.format = format;
 ...
 * @title bidrag-sak
 * @version v1
 * @baseUrl https://bidrag-sak-feature.dev.intern.nav.no
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    bidragSak = {
         ...
         * @tags bidrag-sak-controller
         * @name Find
         * @request GET:/bidrag-sak/person/sak/{fodselsnummer}
         * @secure
         */
        find: (fodselsnummer: string, params: RequestParams = {}) =>
            this.request<BidragSakDto[], void>({
                path: `/bidrag-sak/person/sak/${fodselsnummer}`,
                method: "GET",
                secure: true,
                ...params,
            }),
