...
export interface OpprettJournalpostRequest {
     ...
     * @default "DIGITALT"
     */
    kanal?: OpprettJournalpostRequestKanalEnum;
    /**
    ...
    journalposttype: OpprettJournalpostRequestJournalposttypeEnum;
...
export interface BestemKanalResponse {
    ...
    distribusjonskanal: BestemKanalResponseDistribusjonskanalEnum;
}
...
export interface DistribusjonInfoDto {
    journalstatus: DistribusjonInfoDtoJournalstatusEnum;
    kanal: string;
...
export interface UtsendingsInfoDto {
    varseltype?: UtsendingsInfoDtoVarseltypeEnum;
    adresse?: string;
    tittel?: string;
 ...
 * @default "DIGITALT"
 */
export enum OpprettJournalpostRequestKanalEnum {
    DIGITALT = "DIGITALT",
...
/** Journalposttype, dette kan enten være Inngående, Utgående eller Notat */
export enum OpprettJournalpostRequestJournalposttypeEnum {
    INNGAENDE = "INNGÅENDE",
    UTGAAENDE = "UTGAAENDE",
    UTGAENDE = "UTGÅENDE",
    NOTAT = "NOTAT",
...
export enum BestemKanalResponseDistribusjonskanalEnum {
    PRINT = "PRINT",
    SDP = "SDP",
    DITT_NAV = "DITT_NAV",
...
export enum DistribusjonInfoDtoJournalstatusEnum {
    MOTTATT = "MOTTATT",
    JOURNALFORT = "JOURNALFØRT",
    EKSPEDERT = "EKSPEDERT",
    DISTRIBUERT = "DISTRIBUERT",
...
export enum UtsendingsInfoDtoVarseltypeEnum {
    EPOST = "EPOST",
    SMS = "SMS",
    DIGIPOST = "DIGIPOST",
...
export class HttpClient<SecurityDataType = unknown> {
    ...
    constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
        this.instance = axios.create({
            ...axiosConfig,
            baseURL:
                axiosConfig.baseURL || "https://bidrag-dokument-arkiv-feature.dev.intern.nav.no/bidrag-dokument-arkiv",
        });
        this.secure = secure;
        this.format = format;
...
/**
 * @title bidrag-dokument-arkiv
 * @version v1
 * @baseUrl https://bidrag-dokument-arkiv-feature.dev.intern.nav.no/bidrag-dokument-arkiv
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    journalpost = {
         ...
         *
         * @tags opprett-journalpost-controller
         * @name OpprettJournalpost
         * @request POST:/journalpost
         * @secure
         */
        opprettJournalpost: (data: OpprettJournalpostRequest, params: RequestParams = {}) =>
            this.request<any, OpprettJournalpostResponse>({
                path: `/journalpost`,
                method: "POST",
                body: data,
                secure: true,
    ...
    journal = {
         ...
         * No description
         *
         * @tags avvik-controller
         * @name HentAvvik
         * @summary Henter mulige avvik for en journalpost, id på formatet 'JOARK<journalpostId>'
         * @request GET:/journal/{journalpostId}/avvik
         * @secure
         */
        hentAvvik: (
            journalpostId: string,
            ...
            this.request<HentAvvikEnum[], void>({
                path: `/journal/${journalpostId}/avvik`,
                method: "GET",
                query: query,
                secure: true,
                ...params,
         ...
         * @tags avvik-controller
         * @name BehandleAvvik
         * @summary Behandler et avvik for en journalpost, id på formatet 'JOARK-<journalpostId>'
         * @request POST:/journal/{journalpostId}/avvik
         * @secure
         */
        behandleAvvik: (journalpostId: string, data: Avvikshendelse, params: RequestParams = {}) =>
        ...
        /**
         * @description Hent kanal journalost vil bli distribuert på etter distribusjon er bestilt
         *
         * @tags distribuer-controller
         * @name HentDistribusjonKanal
         * @request POST:/journal/distribuer/kanal
         * @secure
         */
        hentDistribusjonKanal: (data: BestemDistribusjonKanalRequest, params: RequestParams = {}) =>
            this.request<BestemKanalResponse, any>({
                path: `/journal/distribuer/kanal`,
                method: "POST",
                body: data,
                secure: true,
                type: ContentType.Json,
        ...
        /**
         * @description Hent en journalpost for en id på formatet 'JOARK-<journalpostId>'
         *
         * @tags journalpost-controller
         * @name HentJournalpost
         * @request GET:/journal/{joarkJournalpostId}
         * @secure
         */
        hentJournalpost: (
            joarkJournalpostId: string,
            ...
            this.request<JournalpostResponse, JournalpostResponse>({
                path: `/journal/${joarkJournalpostId}`,
                method: "GET",
                query: query,
                secure: true,
                ...params,
        ...
        /**
         * @description endre eksisterende journalpost med journalpostId på formatet 'JOARK-<journalpostId>'
         *
         * @tags journalpost-controller
         * @name Patch
         * @request PATCH:/journal/{joarkJournalpostId}
         * @secure
         */
        patch: (joarkJournalpostId: string, data: EndreJournalpostCommand, params: RequestParams = {}) =>
        ...
        hentDistribusjonsInfo: (journalpostId: string, params: RequestParams = {}) =>
            this.request<DistribusjonInfoDto, DistribusjonInfoDto>({
    ...
    dokument = {
         ...
         * @secure
         */
        hentDokument: (journalpostId: string, dokumentreferanse: string, params: RequestParams = {}) =>
    ...
    dokumentreferanse = {
         ...
         *
         * @tags dokument-controller
         * @name HentDokumentMetadata2
         * @summary Henter dokument for journalpostid og dokumentreferanse.
         * @request OPTIONS:/dokumentreferanse/{dokumentreferanse}
         * @secure
         */
        hentDokumentMetadata2: (dokumentreferanse: string, params: RequestParams = {}) =>
            this.request<DokumentMetadata[], any>({
